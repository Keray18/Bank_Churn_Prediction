...
class DataProcessing():
    ...
    def get_data_processor(self, train_data):
        try:
            ...
            numerical_columns = [col for col in train_data.columns if col not in categorical_columns + ['Exited']]
    ...
    def initiate_data_processing(self, train_data_path, test_data_path):
        try:
            ...
            train_input_feature_arr=preprocessing_obj.fit_transform(train_input_features)
            test_input_feature_arr=preprocessing_obj.transform(test_input_features)
            ...
            train_input_feature_arr, train_target_features = smk.fit_resample(train_input_feature_arr, train_target_features)
